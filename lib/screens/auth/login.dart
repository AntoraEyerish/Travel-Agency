  ...
  void _showErrorDialog(String message) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Row(
          children: [
            Icon(Icons.error_outline, color: Color(0xFFFF4B55), size: 24),
            SizedBox(width: 8),
            Text(
              'Sign In Failed',
              style: TextStyle(
  ...
  void _showNoAccountDialog() {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Row(
          children: [
            Icon(Icons.person_off_outlined, color: Color(0xFFFF4B55), size: 24),
            SizedBox(width: 8),
            Text(
              'No Account Found',
              style: TextStyle(
        ...
        content: const Text(
          'There is no account registered with this email. Would you like to create one?',
